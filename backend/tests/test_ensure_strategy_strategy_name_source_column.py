...
from db.session import ensure_strategy_strategy_name_source_column


def test_ensure_strategy_strategy_name_source_column():
    ...
    assert "strategy_name_source" in cols
    ensure_strategy_strategy_name_source_column(eng)
