...
def fetch_bars(
    ...
    if ticker_type == TickerType.CRYPTO:
        ...
        return _as_ohlcv_dataframe(df)
    raise ValueError(f"Unsupported ticker_type: {ticker_type!r}")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="This is a template of a trading strategy. Implement run_backtest function before using it.")
    parser.add_argument("--backtest", action="store_true", help="Run the backtest using output/params.json")
